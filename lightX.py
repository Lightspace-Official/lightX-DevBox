...
while (crash == 0):   
    ...
    if text == ('example'): # Example command
     print('Welcome to lightX DevBox')
    ...
    elif text == ('install pkg'): # This command is used to install a package from lXPI
        ...
        if help == ('mk program'):
            print('This program opens the lX IDE for you to make a new program.')
        elif help == ('pkg program'):
            print('This command opens the Unpackager which allows you to unpkg a .lxpkg file.')
        else:
            print('Help for this command not found')   
    else:
