...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Text Area
    self.txtarea = Text(self.root,yscrollcommand=scrol_y.set,font=("monospace",15,),state="normal",relief=GROOVE)
  ...
  def saveasfile(self,*args):
    ...
    try:
      ...
      untitledfile = filedialog.asksaveasfilename(title = "Save file As",defaultextension=".lxp",initialfile = "Untitled.lxp",filetypes = (("lX Program File","*.lxp"),("All Files","*.*")))
      # Reading the data from text area
      data = self.txtarea.get("1.0",END)
      # opening File in write mode
  ...
  def infoabout(self):
    messagebox.showinfo("About lightX IDE","A IDE\nCreated using Python.")
